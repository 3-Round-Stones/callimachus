...
public class RDFDeleteTest extends TemporaryServerTestCase {
	...
	public void runTest() throws Exception {
		...
		getHomeFolder().link("describedby")
				.create("application/sparql-update", text.getBytes())
				.link("describedby").delete();
	}
}