...
public class XSLTMethodTest extends TestCase {
	...
	public void test() throws Exception {
		addRdfSource("/org/callimachusproject/xslt/xslt-ontology.ttl");
		ObjectRepositoryFactory ofm = new ObjectRepositoryFactory();
		ObjectRepository repo = ofm.getRepository(converter);
		repo.setDelegate(new SailRepository(new MemoryStore()));
		repo.setDataDir(targetDir);
		...
		try {
			URL url = find("/org/callimachusproject/xslt/xslt-ontology.ttl");
